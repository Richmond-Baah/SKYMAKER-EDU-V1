            ...
            <footer className="py-12 border-t border-white/5 bg-black/40">
                <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex items-center gap-2">
                        <span className="font-black text-xl tracking-tighter uppercase opacity-50">SkyMaker</span>
                    </div>
                    ...
                    <p className="text-[10px] text-gray-700 font-bold uppercase tracking-widest">© 2026 SkyMaker Robotics</p>
                </div>
            </footer>
        </div>
    )
